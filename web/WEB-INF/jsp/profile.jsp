            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content border-left-right">
                        <img alt="image" class="img-responsive" src="<c:out value="${userinfo.avatar}"></c:out>">
                    </div>
                    <div class="ibox-content profile-content">
                        <h4><strong> <c:out value="${userinfo.userName}"></c:out></strong></h4>
                        <p><i class="fa fa-map-marker"></i><c:out value="${userinfo.address}"></c:out></p>
                        <h5>
                            关于我
                        </h5>
                        ${userinfo.remark}
