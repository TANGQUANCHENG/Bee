...
<head>
    ...
    <link href="/static/js/plugins/layer/layim/layim.css" rel="stylesheet">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ sessionScope.userinfo.avatar}" style="width: 40%"/></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${ sessionScope.userinfo.userName}</strong></span>
                                <span class="text-muted text-xs block">超级管理员<b class="caret"></b></span>
                                </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="/uploadController/editAvatar">修改头像</a>
                            </li>
                            <li><a class="J_menuItem" href="/userinfo/profile">个人资料</a>
                            </li>
                            <li><a class="J_menuItem" href="/userinfo/allUsers">全部用户</a>
                            </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/calendarController/calendar" data-index="0">我的日历</a>
                        </li>
                        <li>
                            <a class="J_menuItem" data-field="1" href="/topicController/topicList">话题列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/fileManage/getImages">图片管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/fileManage/getAllFiles">文件管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/webImController/webIm">测试通讯</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/uploadController/baiduWebUpload" >百度上传</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/uploadController/dropZone" >dropZone上传</a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/customerController/customerList">客户管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/projectController/projectList">项目管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/orderController/orderList">订单列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/angularController/angularList">测试Angular</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/bee/datas"
                    frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="text-center">&copy; 2016 <a href="#" target="_blank">tangquancheng</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script src="/static/js/plugins/layer/layim/layer.js"></script>
<script src="/static/js/plugins/layer/layim/layim.js"></script>
...
<script>
    $(document).ready(function(){
        ...
        $(".J_tabExit").click(function(){
            layer.confirm('确定退出当前用户吗？', function(r){
                if(r){
