...
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <dl class="dl-horizontal">
                                ...
                                <dt>项目经理：</dt>
                                <dd>${project.manager.userName}</dd>
                                <dt>消息：</dt>
                                <dd>162</dd>
                                <dt>客户：</dt>
                                <dd><a href="javascript:void(0)" class="text-navy">${project.customerId}</a>
                                </dd>
                                <dt>版本：</dt>
                        ...
                        <div class="col-sm-7" id="cluster_info">
                            <dl class="dl-horizontal">
                                ...
                                <dt>最后更新：</dt>
                                <dd><f:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${project.updateTime}"/></dd>
                                <dt>创建于：</dt>
                                <dd> <f:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${project.createTime}"/></dd>
                                <dt>团队成员：</dt>
                                    ...
                                    <div class="progress progress-striped active m-b-sm">
                                        <c:choose>
                                            <c:when test="${project.done >= 80}">
                                                <div style="width: <c:out value="${project.done}"></c:out>%;" class="progress-bar progress-bar-danger"></div>
                                            </c:when>
                                            <c:when test="${project.done >=50&&project.done <80}">
                                                <div style="width: <c:out value="${project.done}"></c:out>%;" class="progress-bar progress-bar-warning"></div>
                                            </c:when>
                                            <c:otherwise>
                                                <div style="width: <c:out value="${project.done}"></c:out>%;" class="progress-bar"></div>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <small>当前已完成项目总进度的 <strong>${project.done}%</strong></small>
                                </dd>
                            </dl>
                        </div>
                    </div>
                                                        ...
                                                        <div class="photos">
                                                            <a target="_blank"
                                                               href="../../../24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                                                <img alt="image" class="feed-photo" src="/static/img/p1.jpg">
                                                            </a>
                                                            <a target="_blank"
                                                               href="../../../37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                                                <img alt="image" class="feed-photo" src="/static/img/p3.jpg">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="col-sm-3">
        <div class="wrapper wrapper-content project-manager">
            <h4>项目描述</h4>
            <img src="/static/img/wenku_logo.png" class="img-responsive">
            <p class="small">
