...
import com.org.tqc.util.ImageCut;
...
public class KindEditorController {
    ...
    public Map<String, Object> fileUpload(HttpServletRequest request,
        ...
        String savePath = application.getRealPath("/") + "static/uploadImage/" + userFile + "/";

        // 文件保存目录URL
        String saveUrl = request.getContextPath() + "/static/uploadImage/" + userFile + "/";
...
//遍历后缀名map根据文件格式的不同区分写入目录
    ...
    @RequestMapping(value = "/file-manager.do")
    public void fileManager(HttpServletRequest request,
        ...
        // 根目录路径，可以指定绝对路径，比如 /var/www/uploadImage/
        String rootPath = application.getRealPath("/") + "static/uploadImage/" + userFile + "/";
        // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/uploadImage/
        String rootUrl = request.getContextPath() + "/static/uploadImage/" + userFile + "/";
        // 图片扩展名
